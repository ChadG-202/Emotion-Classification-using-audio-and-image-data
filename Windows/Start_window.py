...
class Start():
    ...
    def sentence(self):
        ...
        if self.pos == 0:
            ...
            text += "The application will then preprocess and process the data, before training.\n"
            text += "You will be promoted to take one more picture and one more recording\n"
            text += "in a chosen emotion. This data will be predicted upon before shwoing a\n"
